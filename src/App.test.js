...
// test('me', () => {
//   render(<App />);
//   const val = screen.getByPlaceholderText(/myvalue/i);
//   expect(screen.queryByTestId('valueMy-elem')).toContainHTML('');
//   userEvent.type(val, 'react');
//   expect(screen.queryByTestId('valueMy-elem')).toContainHTML('react');
// });
// });
